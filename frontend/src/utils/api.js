...
export const rankingAPI = {
  ...
  update: (criteriaWeights, alternativesScores, rankingResult, columns = [], groups = []) => 
    api.post('/ranking/update', { criteriaWeights, alternativesScores, rankingResult, columns, groups }),
